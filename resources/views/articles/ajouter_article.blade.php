    ...
    <x-ajouter content="article" toRoute="articles">
        ...
        <div>
            <div class="mb-4">
                ...
                <select name="auteur" id="auteur" class="block bg-gray-200 py-2 px-1 w-full rounded mt-4">
            ...
            <div class="mb-4">
                ...
                <select name="categorie" id="categorie" class="block bg-gray-200 py-2 px-1 w-full rounded mt-4">
            ...
            <div class="mb-4">
                ...
                <select name="date_publication" id="date_publication" class="block bg-gray-200 py-2 px-1 w-full rounded mt-4">
